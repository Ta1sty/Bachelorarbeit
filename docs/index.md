...
You can use the [editor on GitHub](https://github.com/Ta1sty/Traversal-Shader-on-Current-GPUs/edit/master/docs/index.md) to maintain and preview the content for your website in Markdown files.

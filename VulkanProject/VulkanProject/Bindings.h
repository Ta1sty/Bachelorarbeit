...
#define NODE_TRANSFORM_BINDING 5
#define NODE_BUFFER_BINDING 6
...
#define GET_TRANSFORM_BUFFER(VK_INFO) (##VK_INFO->global_buffers.buffer_containers[0].buffers[5])
#define GET_NODE_BUFFER(VK_INFO) (##VK_INFO->global_buffers.buffer_containers[0].buffers[6])
